...
unsigned char* AES::encrypt(const unsigned char* plainText)
{
	...
	unsigned char* cryptpart = new unsigned char[16];
	AES_ecb_encrypt(plainText, cryptpart, &enc_key, AES_ENCRYPT);
	return cryptpart;	
}
...
unsigned char* AES::decrypt(const unsigned char* cipherText)
{
	...
	unsigned char* plainpart = new unsigned char[16];
	AES_ecb_encrypt(cipherText, plainpart, &dec_key, AES_DECRYPT);
	return plainpart;
}
